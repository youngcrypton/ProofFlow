...
function Sidebar({ activeView, network, walletAddress, mobileOpen, onToggle, onConnect, onCreate, onNavigate }: { activeView: View; network: string; walletAddress: string | null; mobileOpen: boolean; onToggle: () => void; onConnect: () => void; onCreate: () => void; onNavigate: (view: View) => void }) {
