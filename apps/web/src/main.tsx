...
function App() {
  ...
  return <div className="app-shell">
    ...
    <main id="main-content" className="main-content">
      ...
      <section className="page-heading"><div><div className="eyebrow">Trust execution console · {statusLabel}</div><h2>Make the next safe move.</h2><p>AI checks the evidence. Policy decides. You approve. X Layer settles.</p></div><div className="heading-actions"><button className="button secondary" disabled={resetting} onClick={() => void resetDemo()}>{resetting ? "Resetting…" : "Reset demo"}</button><button className="button primary" onClick={() => setCreateOpen(true)}>+ Create agreement</button></div></section>
